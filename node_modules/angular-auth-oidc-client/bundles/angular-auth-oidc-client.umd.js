(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/common/http'), require('@angular/router'), require('rxjs/BehaviorSubject'), require('rxjs/Observable'), require('rxjs/operators'), require('jsrsasign')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/common/http', '@angular/router', 'rxjs/BehaviorSubject', 'rxjs/Observable', 'rxjs/operators', 'jsrsasign'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.angularAuthOidcClient = global.ng.angularAuthOidcClient || {}),global.ng.core,global.ng.common,global.ng.common.http,global.ng.router,global.Rx,global.Rx,global.Rx.Observable.prototype,global.jsrsasign));
}(this, (function (exports,_angular_core,_angular_common,_angular_common_http,_angular_router,rxjs_BehaviorSubject,rxjs_Observable,rxjs_operators,jsrsasign) { 'use strict';
...
var OidcSecurityService = /** @class */ (function () {
    ...
    OidcSecurityService.prototype.refreshSession = function () {
        ...
        this.loggerService.logDebug('RefreshSession created. adding myautostate: ' +
            this.oidcSecurityCommon.authStateControl);
        var /** @type {?} */ url = this.createAuthorizeUrl(this.authConfiguration.silent_redirect_url, nonce, state, this.authWellKnownEndpoints.authorization_endpoint, 'none');
